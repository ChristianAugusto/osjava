...
import system.utils.IdIncrement;
...
public class Process {
    ...
    public Process(
        char priority, int arrivalTime, byte processingTime,
        long qtdMemory, byte qtdPrinters, byte qtdScanners, byte qtdModems,
        byte qtdCds, String curentProcessQueueId
    ) {
